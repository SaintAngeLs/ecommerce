    ...
    return (
        <form onSubmit={saveProduct}>
            ...
            <div className="mb-2 flex flex-wrap gap-3">
                ...
                {isUploading && (
                    <div className="h-40 p-1 flex items-center rounded-lg">
                        <Spinner/>
                    </div>
                )}
                <label className="w-40 h-40 cursor-pointer text-center flex flex-col justify-center items-center text-sm gap-2 text-gray-500 rounded-lg bg-gray-200">
